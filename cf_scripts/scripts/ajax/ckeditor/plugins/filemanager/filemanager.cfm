...
<cfif settings.AllowUploads eq "true" or settings.AllowDirectoryCreation eq "true">
<div id="toolbar">
	<cfif settings.AllowUploads eq "true"><img src="images/upload.gif" id="fmupload" class="fmtabslink" /></cfif>
	<cfif settings.AllowDirectoryCreation eq "true"><img src="images/newfolder.gif" id="fmdir" class="fmtabslink" /></cfif>
...
<!---- file upload box       ---->
<cfif settings.AllowUploads eq "true">
...
<!---- new folder box        ---->
<cfif settings.AllowDirectoryCreation eq "true">
...
<div id="holderbox">
	...
	<div id="fmbubhint"></div><div id="fmbubinfo"><span></span> <span></span> </div>
