...
}}}function mtRedirect(a,b){if((a!=null)&&(a.length>0)&&(a.indexOf(document.location.pathname)!=0)){$.ajax({type:"HEAD",url:a,success:function(){$.cookies.set("mtRedirectCheck",document.location.pathname,{hoursToLive:720});
window.location.replace(a)
},error:function(){doRunMT()
}})
}}function checkIfMT(){var b=document.createElement("script");
b.type="text/javascript";
b.async=true;
b.src="https://geo2.adobe.com/json/?callback=checkIfMTCB";
var a=document.getElementsByTagName("script")[0];
a.parentNode.insertBefore(b,a)
}function checkIfMTCB(n){var l=["ru"];
var a=false;
var g=isMTPath();
var h=isLangInPath(l);
var b=getContentLanguage();
var k=getBrowserLang(n);
var f=false;
for(j=0;
j<l.length;
j++){if(k==l[j]){f=true;
break
}}if(g&&f){if(h){if(b=="en"){a=true
}else{clearMTCookie()
}}else{var e=document.location.pathname+document.location.search;
localeURL="/"+k+e;
var d=decodeURIComponent(getMTCookieValue());
if(d==document.location.pathname){a=true
}else{mtRedirect(localeURL,e)
}}}else{clearMTCookie()
}if(a){doRunMT()
}}function getBrowserLang(e){var f=e["Accept-Language"];
var d="";
var b=f.split(",");
if(b.length>0){var a=b[0].toLowerCase();
if((a=="ru")||(a=="ru-ru")||(a=="ru_ru")){d="ru"
}}return d
}function isMTPath(){var d=false;
var b=window.location.href;
var a=b.split("/");
for(i=0;
i<a.length;
i++){if((a[i]=="kb")||(a[i]=="x-productkb")){d=true;
break
}}return d
}function isLangInPath(d){var e=false;
var b=window.location.href;
var a=b.split("/");
for(i=0;
i<a.length;
...
}function getContentLanguage(){var b=null;
var a=document.getElementsByTagName("meta");
for(i=0;
i<a.length;
i++){thisHttpEquiv=a[i].httpEquiv;
if(thisHttpEquiv=="Content-Language"){b=a[i].content
}}return b
}function getCookieLang(b){var e="international";
var d="";
if($.cookies.get(e)){var f=$.cookies.get(e);
for(var a=0;
a<b.length;
a++){if(b[a]==f){d=b[a];
break
}}}return d
}function getMTCookieValue(){var b="mtRedirectCheck=";
...
}function clearMTCookie(){$.removeCookie("mtRedirectCheck",{path:"/"})
}function doRunMT_scTracking(){var a=setInterval(function(){if(typeof _satellite=="object"&&typeof s_adbadobenonacdc=="object"){clearInterval(a);
var b=s_adbadobenonacdc.pageName;
var d=$.cookies.get("translateWidget");
if((d!=null)&&(d==1)){s_adbadobenonacdc.pageName=b+":transwid:ct"
}else{s_adbadobenonacdc.pageName=b+":transwid:in"
}s_adbadobenonacdc.t();
s_adbadobenonacdc.pageName=b
}},500)
}function doRunMT(){clearMTCookie();
var b="https://adobe-swidget.systran.us/systran-tr-widget.min.js";
...
f=function(h){var k,g;
if(typeof h!=="object"||h===null){k=a
}else{k={expiresAt:a.expiresAt,path:a.path,domain:a.domain,secure:a.secure};
if(typeof h.expiresAt==="object"&&h.expiresAt instanceof Date){k.expiresAt=h.expiresAt
}else{if(typeof h.hoursToLive==="number"&&h.hoursToLive!==0){g=new Date();
g.setTime(g.getTime()+(h.hoursToLive*60*60*1000));
k.expiresAt=g
}}if(typeof h.path==="string"&&h.path!==""){k.path=h.path
}if(typeof h.domain==="string"&&h.domain!==""){k.domain=h.domain
}if(h.secure===true){k.secure=h.secure
}}return k
};
e=function(g){g=f(g);
...
d=function(){var r={},k,h,g,q,n=document.cookie.split(";"),l;
for(k=0;
k<n.length;
k=k+1){h=n[k].split("=");
g=h[0].replace(/^\s*/,"").replace(/\s*$/,"");
try{q=decodeURIComponent(h[1])
}catch(p){q=h[1]
}if(typeof JSON==="object"&&JSON!==null&&typeof JSON.parse==="function"){try{l=q;
q=JSON.parse(q)
}catch(o){q=l
}}r[g]=q
}return r
...
b=function(){};
b.prototype.get=function(l){var g,k,h=d();
if(typeof l==="string"){g=(typeof h[l]!=="undefined")?h[l]:null
}else{if(typeof l==="object"&&l!==null){g={};
for(k in l){if(typeof h[l[k]]!=="undefined"){g[l[k]]=h[l[k]]
}else{g[l[k]]=null
}}}else{g=h
}}return g
};
b.prototype.filter=function(g){var l,h={},k=d();
if(typeof g==="string"){g=new RegExp(g)
}for(l in k){if(l.match(g)){h[l]=k[l]
}}return h
};
b.prototype.set=function(l,h,g){if(typeof g!=="object"||g===null){g={}
...
document.cookie=l+"="+encodeURIComponent(h)+k
};
b.prototype.del=function(l,k){var g={},h;
if(typeof k!=="object"||k===null){k={}
}if(typeof l==="boolean"&&l===true){g=this.get()
}else{if(typeof l==="string"){g[l]=true
}}for(h in g){if(typeof h==="string"&&h!==""){this.set(h,null,k)
}}};
b.prototype.test=function(){var h=false,g="cT",k="data";
this.set(g,k);
if(this.get(g)===k){this.del(g);
h=true
}return h
};
...
URLParser=(function(){var n=window.location.toString();
var b=new Array();
var a=new Array();
b=n.split("//");
a=b[1].split("/");
var e=a[0].split(".")[0];
var l=a[1];
l=((l.length==2)||(l=="ca_fr")||(l=="africa")||(l=="be_en")||(l=="be_fr")||(l=="be_nl")||(l=="eeurope")||(l=="il_en")||(l=="il_he")||(l=="lu_de")||(l=="lu_en")||(l=="lu_fr")||(l=="mena_ar")||(l=="mena_fr")||(l=="ch_de")||(l=="ch_fr")||(l=="ch_it")||(l=="hk_zh")||(l=="hk_en")||(l=="sea"))?l:"en_us";
if(l=="en_us"){a.splice(1,0,l)
}var g=a[2];
var k=a[3];
var o=(g=="products")?product=a[3]:"";
var f=a[4];
var p=(g=="products")?product=a[4]:"";
var h=(g=="products")?product=a[5]:"";
var d;
$.each(a,function(q){});
return{url:window.location,path:window.location.pathname,protocol:window.location.protocol,hash:window.location.hash,subDomain:e,host:a[0],locale:l,siteLevel:g,siteSection:k,productName:o,siteSubSection:f,productSection:p,productSubSection:h,fileName:d}
})();
...
adobe.fn.evidon=function(f){var k=$("#"+f),h=document,e,b,a=(h.location.protocol=="https:"?"https":"http"),g=(a=="https"?"https://info.evidon.com/c/betrad/pub/":"http://cdn.betrad.com/pub/");
if((k!=null)&&(hideEvidon!=true)&&isDesktop()){k.show();
...
}}}}}}}}}k.bind("click",function(n){n.preventDefault();
var l=this;
function d(q,t){var r=h.getElementsByTagName("head")[0]||h.documentElement,p=false,o=h.createElement("script");
function s(){o.onload=o.onreadystatechange=null;
r.removeChild(o);
t()
}o.src=q;
o.onreadystatechange=function(){if(!p&&(this.readyState=="loaded"||this.readyState=="complete")){p=true;
s()
}};
o.onload=s;
r.insertBefore(o,r.firstChild)
}d(a+"://ajax.googleapis.com/ajax/libs/jquery/1.4.4/jquery.min.js",function(){d(g+"pub1.js",function(){BAPW.i(l,{pid:b,ocid:414},false)
})
})
});
...
adobe.fn.changeRegionFooter=function(b){if($.string(b).startsWith("be_")){$.cookies.set("international",b,{domain:"adobe.com",hoursToLive:8760});
$.cookies.set("storeregion","be",{domain:"adobe.com",hoursToLive:8760})
}else{if($.string(b).startsWith("ca")){$.cookies.set("international",b,{domain:"adobe.com",hoursToLive:8760});
$.cookies.set("storeregion","ca",{domain:"adobe.com",hoursToLive:8760})
}else{if($.string(b).startsWith("eeur")){$.cookies.set("international",b,{domain:"adobe.com",hoursToLive:8760});
$.cookies.set("storeregion","eu",{domain:"adobe.com",hoursToLive:8760})
}else{if($.string(b).startsWith("hk_")){$.cookies.set("international",b,{domain:"adobe.com",hoursToLive:8760});
$.cookies.set("storeregion","cn",{domain:"adobe.com",hoursToLive:8760})
}else{if($.string(b).startsWith("lu_")){$.cookies.set("international",b,{domain:"adobe.com",hoursToLive:8760});
$.cookies.set("storeregion","lu",{domain:"adobe.com",hoursToLive:8760})
}else{if($.string(b).startsWith("uk")){$.cookies.set("international",b,{domain:"adobe.com",hoursToLive:8760});
$.cookies.set("storeregion","gb",{domain:"adobe.com",hoursToLive:8760})
}else{$.cookies.set("international",b,{domain:"adobe.com",hoursToLive:8760});
$.cookies.set("storeregion",b,{domain:"adobe.com",hoursToLive:8760})
}}}}}}var a=window.location.pathname+window.location.search;
if($.string(a).startsWith("/content/dotcom/")){a=a.replace("/content/dotcom/","/")
}else{if($.string(a).startsWith("/content/help/")){a=a.replace("/content/help/","/")
}}if($.string(a).startsWith("/en/")){a=a.replace("/en/","/")
}var d=a;
var f=null;
var e=["africa","ap","at","au","be_en","be_fr","be_nl","bg","br","ca","ca_fr","ch_de","ch_fr","ch_it","cn","cz","de","dk","eeurope","ee","en","es","fi","fr","hk_en","hk_zh","hr","hu","ie","il_en","il_he","in","it","jp","kr","la","lt","lu_de","lu_en","lu_fr","lv","mena_ar","mena_en","mena_fr","mx","nl","no","nz","pl","pt","ro","ru","si","se","sea","sk","tr","tw","ua","uk"];
$.each(e,function(){if($.string(a).startsWith("/"+this+"/")){a=a.replace("/"+this+"/","/");
return false
}});
if(b!="us"){d="/"+b+a
}else{d=a
...
$(document).ready(function(){if($("#feedbackPod").length!=0){var a=$("#feedbackPod").offset().top-parseFloat($("#feedbackPod").css("margin-top").replace(/auto/,12));
$(function(){if(!/android|iphone|ipod/i.test(navigator.userAgent)){var b=$.browser=="msie"&&$.browser.version<7;
if(!b){var d=$("#feedbackPod").offset.left;
$(window).scroll(function(e){var f=$(this).scrollTop();
if(f>=(a-8)){$("#feedbackPod").addClass("feedbackPodFixed")
...
$(function(){if(!/android|iphone|ipod/i.test(navigator.userAgent)){var d=$.browser=="msie"&&$.browser.version<7;
if(!d){var e=$("#feedbackPod").offset.left;
$(window).scroll(function(f){var g=$(this).scrollTop();
if(g>=(a-8)){$("#feedbackPod").addClass("feedbackPodFixed")
}else{$("#feedbackPod").removeClass("feedbackPodFixed")
}})
}}})
}});
